...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		panel.addTab("Reservas", new ImageIcon(Busqueda.class.getResource("/com/hotel/images/reservado.png")), tbReservas, null);
		...
		panel.addTab("Huéspedes", new ImageIcon(Busqueda.class.getResource("/com/hotel/images/pessoas.png")), tbHuespedes, null);
		...
		lblNewLabel_2.setIcon(new ImageIcon(Busqueda.class.getResource("/com/hotel/images/Ha-100px.png")));
