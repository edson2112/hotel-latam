...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int registro_id) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHuesped.class.getResource("/com/hotel/images/lOGO-50PX.png")));
		...
		txtFechaN.getCalendarButton().setIcon(new ImageIcon(RegistroHuesped.class.getResource("/com/hotel/images/icon-reservas.png")));
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (!txtNombre.getText().isEmpty() && !txtNreserva.getText().isEmpty()) {
					guardarHuesped();
				} else {
		...
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/com/hotel/images/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/com/hotel/images/Ha-100px.png")));
